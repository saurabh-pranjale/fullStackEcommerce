            ...
            <div className=" border-2 border-black md:w-[40%] m-auto w-[95%] h-[20rem]  mt-2">
              <section className="w-[94%]   m-auto my-1">
                ...
                <div className="py-2">
                  ...
                  <p className="font-bold py-1">Sub Total: <span className="font-normal"> ${totalAmount} </span></p>
                  <p className="font-bold py-1">Delivery Charges: <span className="font-normal"> ${shippingCharge} </span></p>
                  <p className="font-bold py-1">Total Amount:  <span className="font-normal"> ${totalAmount + shippingCharge} </span></p>
                </div>
